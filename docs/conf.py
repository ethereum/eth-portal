# -*- coding: utf-8 -*-
#
# Portal Network Tools documentation build configuration file, created by
...
htmlhelp_basename = 'eth_portaldoc'
...
latex_documents = [
  ('index', 'eth_portal.tex', 'Portal Network Tools Documentation',
...
man_pages = [
    ('index', 'eth_portal', 'Portal Network Tools Documentation',
